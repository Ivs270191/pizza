...
import { addCartItems, minusItems, removeCartItems } from "../redux/slices/cartSlice";

const CartItem = (props) => {
    const dispatch = useDispatch()
    const onClickPlus = () => {
        dispatch(addCartItems({id:props.id , types: props.types}))
    }
    const onClickMinus = () => {
        dispatch(minusItems({id:props.id , types: props.types}))
    }
    const onClickRemove = () => {
        dispatch(removeCartItems({id:props.id , types: props.types}))
    }
